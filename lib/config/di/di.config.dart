...
import '../../features/auth/signup/presentation/cubit/signup_cubit.dart'
    as _i842;
import '../../features/home/examscreen/api/exam_api_client.dart' as _i234;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i234.ExamApiClient>(() => dioModule.examApiClient);
    ...
    gh.lazySingleton<_i562.ExamRemoteDataSource>(
        () => _i562.ExamRemoteDataSourceImpl(
              gh<_i234.ExamApiClient>(),
    ...
    gh.lazySingleton<_i26.ExamRepository>(
    ...
    gh.lazySingleton<_i434.GetExamQuestionsUseCase>(
